...
- **openai** — SDK OpenAI-compatible, conectado ao DeepSeek (modelo `deepseek-chat`)
...
- `.env` — chave da API DeepSeek (gitignored)
...
- Usar SDK `openai` apontando para `api.deepseek.com` (modelo `deepseek-chat`)
